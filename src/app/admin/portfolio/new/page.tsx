...
import { createPortfolioAction } from "@/app/actions/content";
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        <div className="bg-card border border-border p-6 rounded-lg shadow-sm space-y-6">
          <div className="space-y-2">
            ...
            <input required type="text" name="title" className="w-full border border-input rounded-md px-4 py-2 bg-transparent" placeholder="e.g. Smart Farm IoT System" />
          </div>

          <div className="space-y-2">
            <label className="text-sm font-medium">Description *</label>
            <textarea required name="description" rows={5} className="w-full border border-input rounded-md px-4 py-2 bg-transparent resize-y" placeholder="Describe the project..." />
          </div>

          <div className="grid grid-cols-2 gap-6">
            <div className="space-y-2">
              <label className="text-sm font-medium">Client Name</label>
              <input type="text" name="client" className="w-full border border-input rounded-md px-4 py-2 bg-transparent" placeholder="e.g. AgroCorp" />
            </div>
            <div className="space-y-2">
              <label className="text-sm font-medium">Industry</label>
              <input type="text" name="industry" className="w-full border border-input rounded-md px-4 py-2 bg-transparent" placeholder="e.g. Agriculture" />
            </div>
            <div className="space-y-2 col-span-2">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input type="text" name="image" className="w-full border border-input rounded-md px-4 py-2 bg-transparent text-sm" placeholder="https://example.com/project.png" />
                </div>
              </div>
            </div>
            <div className="space-y-2 col-span-2">
              <label className="text-sm font-medium">Technologies Used (comma separated)</label>
              <input type="text" name="technologies" className="w-full border border-input rounded-md px-4 py-2 bg-transparent" placeholder="e.g. ESP32, React, Node.js" />
            </div>
          </div>
        </div>
