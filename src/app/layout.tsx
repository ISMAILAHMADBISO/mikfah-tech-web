...
export const metadata: Metadata = {
  ...
  description: "MIKFAH TECH LTD develops hardware, software, IoT systems, 3D printing prototypes, print branding, event souvenirs, websites, and supplies quality electronic components.",
  keywords: ["MIKFAH TECH", "Electronic Components", "IoT Solutions", "PCB Design", "3D Printing", "Branding & Banners", "Custom Souvenirs", "Software Development", "Web Development", "Nigeria Tech Company"],
